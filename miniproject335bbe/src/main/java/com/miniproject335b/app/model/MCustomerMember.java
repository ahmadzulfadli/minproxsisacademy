...
public class MCustomerMember {
	...
	public MCustomerRelation getMcustomerrelation() {
		return mcustomerrelation;
	}
	public void setMcustomerrelation(MCustomerRelation mcustomerrelation) {
		this.mcustomerrelation = mcustomerrelation;
	}
